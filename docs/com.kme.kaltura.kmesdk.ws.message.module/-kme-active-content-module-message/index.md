---
title: KmeActiveContentModuleMessage - kmeSdk
---

[kmeSdk](../../index.html) / [com.kme.kaltura.kmesdk.ws.message.module](../index.html) / [KmeActiveContentModuleMessage](./index.html)

# KmeActiveContentModuleMessage

`class KmeActiveContentModuleMessage<T : `[`ActiveContentPayload`](-active-content-payload/index.html)`> : `[`KmeMessage`](../../com.kme.kaltura.kmesdk.ws.message/-kme-message/index.html)`<`[`T`](index.html#T)`>`

### Types

| [ActiveContentPayload](-active-content-payload/index.html) | `class ActiveContentPayload : `[`Payload`](../../com.kme.kaltura.kmesdk.ws.message/-kme-message/-payload/index.html) |
| [SetActiveContentPayload](-set-active-content-payload/index.html) | `data class SetActiveContentPayload : `[`ActiveContentPayload`](-active-content-payload/index.html) |

### Constructors

| [&lt;init&gt;](-init-.html) | `KmeActiveContentModuleMessage()` |
